...
/** Resolve the active theme; an unknown key falls back to the default instead of failing. */
export function resolveTheme(key: string | undefined = process.env.OMNION_WEB_THEME): SiteTheme {
